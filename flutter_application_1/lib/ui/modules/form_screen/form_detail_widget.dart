...
import 'evevated_button_widget.dart';
    ...
    return Consumer<AppViewModel>(builder: (context, viewModel, child) {
      return Form(
        ...
        child: Column(children: [
          EditFieldWidget(
            name: "Nombre:",
            strValue: widget.product.name,
            type: InputType.stringShortType,
          ...
          EditFieldWidget(
            name: "Descripción:",
            strValue: widget.product.description,
            type: InputType.stringLongType,
            onChanged: (String value) {
              _description = value;
            },
          ),
          EditFieldWidget(
            name: "Precio:",
            strValue: widget.product.price.toString(),
          ...
          EditFieldWidget(
            name: "Cantidad:",
            strValue: widget.product.qty.toString(),
